// ======================================================================
// EXERBUD AI — BACKEND WITH PRISMA MEMORY + PROGRESS EVENTS
// - CORS + GET healthcheck
// - PDF Export (centered logo)
// - Vision support via attachments (image_url)
// - Optional Google Search (if GOOGLE_API_KEY / GOOGLE_CX set)
...
// Lazy Prisma init so Vercel hot reloads don't explode
let prisma = null;
function getPrisma() {
  if (!prisma) {
